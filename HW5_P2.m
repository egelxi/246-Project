...
rho=1.0;
d_sw=75; % distance between shear walls [ft]
M=((d_sw/2)+(0.05*Lf))/d_sw;
accTfactor=M/0.5;
...
V_s(6)=FL_AT(16,1);
V_s(5)=FL_AT(16,1)+FL_AT(13,1);
V_s(4)=FL_AT(16,1)+FL_AT(13,1)+FL_AT(10,1);
V_s(3)=FL_AT(16,1)+FL_AT(13,1)+FL_AT(10,1)+FL_AT(7,1);
V_s(2)=FL_AT(16,1)+FL_AT(13,1)+FL_AT(10,1)+FL_AT(7,1)+FL_AT(4,1);
V_s(1)=FL_AT(1,1)+FL_AT(4,1)+FL_AT(7,1)+FL_AT(10,1)+FL_AT(13,1)+FL_AT(16,1);
V_sn=V_s./Wt;
...
OTM = zeros(6,1);
OTM(6)=FL_AT(16,1)*H(6);
OTM(5)=FL_AT(16,1)*H(6)+FL_AT(13,1)*H(5);
OTM(4)=FL_AT(16,1)*H(6)+FL_AT(13,1)*H(5)+FL_AT(10,1)*H(4);
OTM(3)=FL_AT(16,1)*H(6)+FL_AT(13,1)*H(5)+FL_AT(10,1)*H(4)+FL_AT(7,1)*H(3);
OTM(2)=FL_AT(16,1)*H(6)+FL_AT(13,1)*H(5)+FL_AT(10,1)*H(4)+FL_AT(7,1)*H(3)+FL_AT(4,1)*H(2);
OTM(1)=FL_AT(1,1)*H(1)+FL_AT(4,1)*H(2)+FL_AT(7,1)*H(3)+FL_AT(10,1)*H(4)+FL_AT(13,1)*H(5)+FL_AT(16,1)*H(6);
...
sgtitle('East-West Structural Responses')  
